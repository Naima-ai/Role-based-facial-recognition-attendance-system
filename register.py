...
class Register:
    def __init__(self, root):
        ...
        # Combo Box1
        self.combo_security = ttk.Combobox(frame, textvariable=self.var_sq, font=("times new roman", 15, "bold"),
                                           state="readonly")
        ...
        radiobtn1 = ttk.Radiobutton(frame, variable=self.var_rad1, text="Teacher", value="Teacher")
        radiobtn1.place(x=533, y=450)
        radiobtn2 = ttk.Radiobutton(frame, variable=self.var_rad1, text="Student", value="Student")
        radiobtn2.place(x=650, y=450)
        ...
        regbtn = Button(frame, command=self.reg, text="Register", font=("times new roman", 15, "bold"), bd=0,
                          relief=RIDGE, fg="#fff", bg="#002B53", activeforeground="white", activebackground="#007ACC")
        regbtn.place(x=300, y=510, width=270, height=35)



    def reg(self):
        if (
                self.var_fname.get() == "" or self.var_lname.get() == "" or self.var_email.get() == "" or self.var_sq.get() == "Select" or self.var_sa.get() == "" or self.var_password.get() == "" or self.var_rad1.get()== "" or self.var_cpwd.get() == ""):
