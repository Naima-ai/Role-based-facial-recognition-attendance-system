...
class Face_recognition_System:
    ...
    def __init__(self,root):
        ...
        # Detect face button
        img2 = Image.open(r"E:\Nova Work\project-ml using python\facialrecognitionsystem\record2.webp")
        img2 = img2.resize((220,200), Image.Resampling.LANCZOS)  # high level img to lowlevel img
        self.photoimg2 = ImageTk.PhotoImage(img2)
        b2 = Button(bg_img, image=self.photoimg2, cursor="hand2",command=self.face_detect)
        b2.place(x=500, y=220, width=220, height=200)

        b2_lbl = Button(bg_img, text="Record Attendance", cursor="hand2",command=self.face_detect, font=("times new roman", 15, "bold"), bg="darkblue",
                    fg="white")
        b2_lbl.place(x=500, y=420, width=220, height=40)

        # Attendence face button
        img3 = Image.open(r"E:\Nova Work\project-ml using python\facialrecognitionsystem\studentdet.jpg")
        img3 = img3.resize((220,200), Image.Resampling.LANCZOS)  # high level img to lowlevel img
        self.photoimg3 = ImageTk.PhotoImage(img3)
        b3 = Button(bg_img, image=self.photoimg3,command=self.attendance_data, cursor="hand2")
        b3.place(x=800, y=220, width=220, height=200)

        b3_lbl = Button(bg_img, text="Attendance Sheet",command=self.attendance_data, cursor="hand2", font=("times new roman", 15, "bold"),
                        bg="darkblue",
                        fg="white")
        b3_lbl.place(x=800, y=420, width=220, height=40)
